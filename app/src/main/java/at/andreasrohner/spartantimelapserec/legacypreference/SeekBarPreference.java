...
public class SeekBarPreference extends DialogPreference implements SeekBar.OnSeekBarChangeListener {
	...
	public void setOnFormatOutputValueListener(OnFormatOutputValueListener listener) {
	...
	protected void onBindDialogView(View v) {
		...
		mValueDisp = (TextView) v.findViewById(R.id.dialog_seekbar_preference_value);

		mSeekBar = (SeekBar) v.findViewById(R.id.dialog_seekbar_preference_control);
